...
def transformation(image):
  ...
  edges = cv2.Canny(threshold,30,500,apertureSize = 7)
...
def final_image(rotated):
  ...
  sharpened=increase_brightness(sharpened,10)  
  return sharpened



path = "D:\Python\floorplan.jpeg"
...
cv2.imwrite("scanned_image.jpg", cleaned_image)
